...
export const NativeBanner = React.memo(({reposName, myindex = 0}) => {
  const {AddConfig} = useSelector(state => state.remoteConfigReducer);
  //console.log(AddConfig, 'SNNSNSNSNSN');
  ...
  const onAdLoaded = data => {
    //console.log(data, "onAdLoadedonAdLoaded");
  };
      ...
      <View style={{
        ...
        {error ? null : loading ? (
          <View style={styles.loadingView}>
            ...
            <ShimmerPlaceholder style={styles.shimerCallToactionView}>
              <CallToActionView
